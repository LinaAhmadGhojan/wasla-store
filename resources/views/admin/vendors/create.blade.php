...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="h3 mb-1">Create Store</h1>
                <p class="text-muted mb-0">Register a new storefront and connect it to a seller account.</p>
            </div>
                ...
                <form action="{{ route('admin.vendors.store') }}" method="post">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="owner_id" class="form-select" required>
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}" @selected(old('owner_id') == $user->id)>{{ $user->name }} ({{ $user->email }})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="commission_rate" value="{{ old('commission_rate', $vendor->commission_rate ?? 20) }}" class="form-control" step="0.01" required />
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Delivery Fee</label>
                            <input type="number" name="delivery_fee" value="{{ old('delivery_fee', $vendor->delivery_fee ?? 0) }}" class="form-control" step="0.01" />
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_open" value="1" @checked(old('is_open', $vendor->is_open ?? true))>
                            </div>
                        </div>
                        <div class="col-12">
